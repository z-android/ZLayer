...
public class ZAppUtil {
    ...
    public static void redirectActivity(Context context, Class<?> dstClass) {
        ...
        intent.setClass(context, dstClass);
    ...
    public static void setImageBackground(Context context, ImageView imageView, int drawableNormal) {
        InputStream inputStream = context.getResources().openRawResource(drawableNormal);
